...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "O8DCoMIFJ35u2WSTVubk667id";
	public static final String REST_CONSUMER_SECRET = "o7zNADIgblsxrbnY8tHDHCbpXiwj6ujwpUlYG7KSXgvsTB8dqZ"; // Change this
	...
	public void replyToTweet(String message, long uid, AsyncHttpResponseHandler handler){
		String apiUrl = getApiUrl("statuses/update.json");
		RequestParams params = new RequestParams();
		params.put("status", message);
	...
	public void searchTweet(String queryParam, AsyncHttpResponseHandler handler){
